  ...
  const fetchData = async () => {
    try {
      const response = await Axios.get(
        "https://vszsuwqrx5znei4sssizlp3qra0kvejv.lambda-url.us-west-2.on.aws/"
      );
  ...
  return (
    <>
      ...
      >
        <Backdrop
          open={loading}
          sx={{ color: "#ddd", zIndex: 1300, backdropFilter: "blur(1px)" }}
        >
          ...
          <Box sx={{ flexGrow: 1 }}>
            ...
            >
              ...
              <Grid item xs={12} md={6}>
                <Card
                  sx={{ boxShadow: 3, borderRadius: 2, p: 2, height: "100%" }}
                >
                  <CardContent>
